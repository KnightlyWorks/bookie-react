...
export default function Header() {
  ...
  return (
    <header className="flex gap-4 items-center justify-between p-4 bg-surface border-b-2 rounded-b-xl border-b-secondary transition-all duration-300">
      ...
      {/*
        TODO: When(or if?) there's a lot of logic dependent on screen size,
        create a WindowSizeContext + useWindowSize hook.
        For now, Tailwind breakpoints (md:hidden) are enough.
      */}
